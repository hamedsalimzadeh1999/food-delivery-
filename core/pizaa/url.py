...
from .views import adminloginview,adminpage,adminauth,logoutadmin,add_pizza,viewpizaa,editpizaa,deletepizaa,HomePage,signupuser,logoutuser,userauth,loginuser,customerpage,placeorder
urlpatterns = [
    ...
    path('coustomerorder',placeorder,name="placeorder")
